...
namespace BattleSnake.Service {
    /// <summary>
    /// Interface that must be implemented for each instance controller. An instance controller is
    /// instantiated per snake instance.
    /// </summary>
    public interface ISnakeInstanceController {
        string Name { get; }
